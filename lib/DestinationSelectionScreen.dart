...
class DestinationSelectionScreen extends StatefulWidget {
  ...
  final BusStop? selectedDestination;
  ...
  Future<void> _loadBusStopsWithDistance() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Filter out the from stop if provided
        final filteredStops =
            stops
                .where(
                  (stop) =>
                      widget.fromStop == null ||
                      stop.name != widget.fromStop!.name,
                )
                .toList();
  ...
  Widget _buildBusStopsList() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final isSelected = widget.selectedDestination?.name == stop.name;
